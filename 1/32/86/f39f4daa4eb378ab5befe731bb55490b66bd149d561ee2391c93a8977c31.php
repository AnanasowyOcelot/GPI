...
class __TwigTemplate_3286f39f4daa4eb378ab5befe731bb55490b66bd149d561ee2391c93a8977c31 extends Sonata\CacheBundle\Twig\TwigTemplate14
{
...
<article class=\"sonata-blog-post-container\">
    ...
    ";
        ...
        if ($this->getAttribute((isset($context["post"]) ? $context["post"] : $this->getContext($context, "post")), "iscommentable", array())) {
            // line 63
            echo "        ";
            echo $this->env->getExtension('actions')->renderUri($this->env->getExtension('sonata_page')->controller("SonataNewsBundle:Post:addCommentForm", array("postId" => $this->getAttribute((isset($context["post"]) ? $context["post"] : $this->getContext($context, "post")), "id", array()), "form" => (isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")))), array());
            // line 67
            echo "    ";
        } else {
            // line 68
...
";
    ...
    {
        return array (  145 => 18,  142 => 17,  139 => 16,  134 => 72,  128 => 69,  125 => 68,  122 => 67,  119 => 63,  117 => 62,  114 => 61,  112 => 60,  105 => 57,  103 => 56,  95 => 50,  84 => 48,  80 => 47,  73 => 44,  69 => 42,  65 => 40,  63 => 39,  54 => 33,  48 => 32,  40 => 27,  32 => 21,  30 => 16,  27 => 15,  23 => 14,  20 => 13,);
    }
}

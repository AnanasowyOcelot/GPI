        ...
        if ((isset($context["error_delay"]) ? $context["error_delay"] : $this->getContext($context, "error_delay"))) {
            ...
            if ((twig_length_filter($this->env, (isset($context["errors"]) ? $context["errors"] : $this->getContext($context, "errors"))) > 0)) {
                ...
                if (($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "parent", array()) == null)) {
                    // line 496
                    echo "            ";
                    $context["__internal_64a56f20894599b0bc08cf4b3a8b5b0a4d4b4282e7f531ffd085225f07f91bc2"] = $this->env->loadTemplate("MopaBootstrapBundle::flash.html.twig");
                    // line 497
                    echo "            ";
                    $context['_parent'] = (array) $context;
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["error"]) {
                        // line 498
                        echo "                ";
                        echo $context["__internal_64a56f20894599b0bc08cf4b3a8b5b0a4d4b4282e7f531ffd085225f07f91bc2"]->getflash("danger", (((null === $this->getAttribute($context["error"], "messagePluralization", array()))) ? ($this->env->getExtension('translator')->trans($this->getAttribute($context["error"], "messageTemplate", array()), $this->getAttribute($context["error"], "messageParameters", array()), "validators")) : ($this->env->getExtension('translator')->transchoice($this->getAttribute($context["error"], "messageTemplate", array()), $this->getAttribute($context["error"], "messagePluralization", array()), $this->getAttribute($context["error"], "messageParameters", array()), "validators"))));
                        // line 503
                        echo "
            ";
                    }
